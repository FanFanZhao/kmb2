$(function () {
  ...
  $('.total-list').on('click', '.renewal', function (e) {
    ...
    layer.open({
      content: '<p class="active_surplus">续费价格:</p><p class="active_surplus">' + $(this).attr('data-price') + 'BHC</p>',
      btn: ['确认'],
  ...
  $('.layer_box ').on('click', '.updateok', function () {
    ...
    layer.open({
      content: '<p class="active_surplus">升级价格:</p><p class="active_surplus">' + $(this).attr('data-price') + 'BHC</p>',
      btn: ['确认升级'],
      yes: function (index, layero) {
        layer_loading();
           ...
           <li class="  ptb10 mlr10 plr10 alcenter bdb">
                <div class='flex alcenter'>
                        <div class="flex2">
                            ...
                            <p class="ft12 mb10">每小时轮回${list[i].hour_value} BHC</p>
                            <p class="ft12 mb10">总产量${list[i].total_value} BHC</p>
                            <p class="ft14 red2">升级价格：${list[i].up_price} BHC</p>
                        </div>
                        <div class='flex1 tr'>
